...
Revision ID: 2d6c5fd6fba4
Revises: 8642f224c1c3
Create Date: 2021-06-10 10:02:37.700278
...
revision = '2d6c5fd6fba4'
down_revision = '8642f224c1c3'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    # op.drop_index('fk_orderitem_order', table_name='orderitem')
