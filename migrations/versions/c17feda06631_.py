...
Revision ID: c17feda06631
Revises: 
Create Date: 2021-06-10 00:59:21.072474
...
def upgrade():
    ...
    # op.drop_column('orderitem', 'number')
...
def downgrade():
    ...
    op.add_column('orderitem', sa.Column('number', mysql.INTEGER(), autoincrement=False, nullable=True))
